...
const BLOG = {
  AUTHOR: '执人间', // 作者
  BIO: ' 尽善尽美，虚怀若谷！ ', // 作者简介
  LINK: 'https://notion-next-sepia.vercel.app/', // 网站地址
  KEYWORDS: 'Notion,博客,执方书院,执人间', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'ce6bc4db36d74f9296fa74b7eba6a97f', // Important page_id！！！Duplicate Template from  https://https://www.notion.so/ce6bc4db36d74f9296fa74b7eba6a97f?v=324d3754bd59417aa1536c163a3f37a1
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '湘ICP备2022016945号', // 备案号 闽ICP备XXXXXXX
  ...
  CONTACT_TELEGRAM: 'https://www.zhifangshuyuan.top',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'https://github.com/zhirenjian?tab=repositories', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'giscus', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'giscus', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'zhirenjian/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // gitalk评论插件 更多参考 https://gitalk.github.io/
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'NotionNext', // 你的Github仓库名，例如 'NotionNext'
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || '执人间', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || '执人间', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  COMMENT_VALINE_PLACEHOLDER: process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '善语结善缘，恶语伤人心~', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
